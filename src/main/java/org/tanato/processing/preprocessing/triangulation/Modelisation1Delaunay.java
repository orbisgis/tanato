...
public class Modelisation1Delaunay {

	public static DataSourceFactory dsf = new DataSourceFactory();

	// /public static String pathTopo =
	// "/home/bocher/Bureau/avupur/data/courbeschezine.shp";

	public static String pathTopo = "/home/bocher/Bureau/avupur/modelisation1/courbeschezine.shp";

	// public static String pathPtTopo =
	// "/home/bocher/Bureau/avupur/modelisation1/pointsZ.gdms";

	// public static String pathDitches =
	// "/home/bocher/Bureau/avupur/modelisation3/rivers_bdTopo.shp";
...
//						gid++;
		...
		for (int i = 0; i < sdsditches.getRowCount(); i++) {
			...
			String typeValue = ConstraintType.RIVER;
			...
			for (int j = 0; j < geom.getNumGeometries(); j++) {
				...
				if (subGeom instanceof LineString) {
					...
					getBreaklines(lineString, typeValue);
	...
	private static void getBreaklines(LineString lineString, String typeValue) {
		Coordinate[] coords = lineString.getCoordinates();
		...
		for (int k = 1; k < coords.length; k++) {
			...
			if (typeValue.equalsIgnoreCase(ConstraintType.RIVER)) {
				MyEdge edge = new MyEdge(p0, p1, ConstraintType.RIVER, gid);
				breaklines.add(edge);
			} else if (typeValue.equalsIgnoreCase(ConstraintType.DITCH)) {
				MyEdge edge = new MyEdge(p0, p1, ConstraintType.DITCH, gid);
				breaklines.add(edge);
			} else {
