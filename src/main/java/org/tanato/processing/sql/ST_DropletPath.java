...
public class ST_DropletPath implements CustomQuery {
     ...
     */
    private void populateData(DataSourceFactory dsf, DataSource[] tables, IProgressMonitor pm) throws ExecutionException, DriverException, NoSuchTableException, IndexException {
        // First is points
     ...
     * @return
     */
    private double getSlope(DEdge anEdge, DPoint Reference) throws DelaunayError {
        double slope = 0.0;
     ...
     * @return
     */
    private double getSlope(DTriangle aTriangle, DPoint Reference) throws DelaunayError {
        double slope = 0.0;
